// @TODO(dohyun) 임시 id임 나중에 다시 발급받을 예정, 나중에 발급받은 후 .env 파일로 옮길 예정
export const GOOGLE_CLIENT_ID =
  '135690089362-ajbisu3vdskt7eogjk847bpt9hgc7hav.apps.googleusercontent.com';

export const EMOJI_URL = 'https://twemoji.maxcdn.com/2/72x72';

export const AGREEMENT_TERMS_AND_CONDITIONS = `
<h2> 제 1 장 총 칙 </h2>
<h3> 제 1 조 (목적) </h3>

이 약관은 도토리함(이하 "사이트"라 합니다)에서 제공하는 인터넷서비스(이하 "서비스"라 합니다)의 이용 조건 및 절차에 관한 기본적인 사항을 규정함을 목적으로 합니다. <br />
...
③ 닉네임 : 회원의 식별과 서비스 이용을 위하여 회원의 이메일주소 혹은 회원이 변경하고 사이트가 승인하는 문자와 숫자의 조합을 말합니다. <br />
④ 비밀번호 : 회원이 닉네임과 일치된 회원임을 확인하고, 회원 자신의 비밀을 보호하기 위하여 회원이 정한 문자와 숫자의 조합을 말합니다. <br />
⑤ 회원탈퇴 : 사이트 또는 회원이 서비스 이용계약을 취소하는 것을 말합니다. <br />

<h2> 제 2 장 서비스 이용계약 </h2>

<h3> 제 4 조 (이용계약의 성립) </h3>

① 이용약관 상단의 동의 버튼을 누르면 이 약관에 동의하는 것으로 간주됩니다. <br />
② 이용계약은 서비스 이용희망자의 이용약관 동의 후 이용 신청에 대하여 사이트가 승낙함으로써 성립합니다. <br />
③ 구글 사이트를 통하여 회원가입 시 이용약관 및 개인정보 처리방침에 동의하는 것으로 간주되며 이때 회원의 편의를 위해 회원이 설정하는 정보에 대하여 알림을 발송하는 것에 동의하는 것으로 간주됩니다.<br />
...
<h3> 제 10 조 (회원 닉네임과 비밀번호 관리에 대한 회원의 의무) </h3>

① 닉네임과 비밀번호에 대한 모든 관리는 회원에게 책임이 있습니다. 회원에게 부여된 닉네임과 비밀번호의 관리소홀, 부정사용에 의하여 발생하는 모든 결과에 대한 전적인 책임은 회원에게 있습니다. <br />
② 자신의 닉네임이 부정하게 사용된 경우 또는 기타 보안 위반에 대하여, 회원은 반드시 사이트에 그 사실을 통보해야 합니다. <br />
...
(시행일) 이 약관은 2021년 12월부터 시행합니다.`;

export const AGREEMENT_PRIVACY_POLICY = `
<h3>1. 수집하는 개인정보 항목 및 이용 목적 <br /></h3>
    1) 회원가입 시<br />
    <br />
    - 수집목적 : 회원제 서비스 가입 <br />
    - 수집항목 : 이메일주소, 비밀번호<br />
    ...
    <br />
    - 서비스 이용 기록, 접속 로그, 쿠키, 접속 IP 정보<br />
    - 모바일 서비스의 특성상 단말기 모델 정보가 수집될 수 있으나, 이는 개인을 식별할 수 없는 형태입니다.<br />
    <br />
<h3>2. 개인정보의 보유 및 이용기간<br /></h3>
    회원탈퇴를 요청하거나 개인정보의 수집 및 이용에 대한 동의를 철회하는 경우, 수집 및 이용목적이 달성되거나 이용기간이 종료한 경우 개인정보를 해지 접수일로부터 5일 이내 파기합니다.<br />
    <br />
